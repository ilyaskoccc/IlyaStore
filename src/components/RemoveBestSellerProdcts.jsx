...
import cardProduct2 from "../../images/card-2.jpeg";
import { ChevronLeft, ChevronRight } from "lucide-react";

export default function RemoveBestSellerProducts() {
  const removeBestSellerProducts = [
    {
      id: 1,
    ...
    <div className="flex justify-center md:justify-between md:px-40 md:py-5 items-center flex-wrap md:flex-nowrap">
      <div className="flex flex-col md:pb-34">
        ...
        <div className="flex flex-wrap justify-center gap-6 items-center">
          {removeBestSellerProducts.map((product) => (
            <>
